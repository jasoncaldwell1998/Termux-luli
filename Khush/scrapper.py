...
api_id = 2410047
api_hash = '0808c8985e03f6eb6df122b1a27592d8'
phone = +919443546972
...
target = 'https://t.me/moderncryptotalk'

all_participants = client.get_participants(target, aggressive=True)

print('Saving In file...')
with open("E:\Telegram Scripts Bundle\Scripts\members.csv","w",encoding='UTF-8') as f:
